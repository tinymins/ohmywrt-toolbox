  ...
  translation: {
    ...
    proxy: {
      ...
      debug: {
        ...
        filteredNodes: "被過濾的節點",
        finalConfig: "最終配置",
        fetchingSource: "正在獲取訂閱源...",
        httpStatus: "HTTP 狀態碼",
        responseSize: "響應大小",
        detectedFormat: "檢測到的格式",
        nodeStats: "節點統計",
        matchedRule: "匹配規則",
        proxyGroups: "代理分組",
        rules: "規則",
      ...
      form: {
        ...
        dnsConfigLabel: "DNS 配置 (JSONC，支援註解)",
        dnsConfigPlaceholder: '{"localDns": "127.0.0.1", "fakeipEnabled": true}',
        dnsLocalDns: "本機 DNS 服務器",
        dnsLocalDnsDesc: "用於解析中國大陸域名的本機 DNS 地址",
        dnsLocalDnsPort: "本機 DNS 端口",
        ...
        dnsFakeipTtlDesc: "FakeIP 緩存 TTL（單位: 秒）",
        dnsDnsListenPort: "DNS 監聽端口",
        dnsDnsListenPortDesc: "Sing-box DNS 服務監聽端口",
        dnsTproxyPort: "TProxy 端口",
        dnsTproxyPortDesc: "透明代理端口（Clash / Sing-box）",
        dnsRejectHttps: "攔截 HTTPS DNS",
        dnsRejectHttpsDesc: "攔截系統發出的 HTTPS 類型 DNS 查詢",
        dnsCnDomainLocalDns: "國內域名走本機 DNS",
        dnsCnDomainLocalDnsDesc: "中國大陸域名使用本機 DNS 解析",
        dnsClashApiPort: "Clash API 端口",
        dnsClashApiPortDesc: "Sing-box Clash API 監聽端口",
        dnsClashApiSecret: "Clash API 密鑰",
        dnsClashApiUiPath: "Clash UI 路徑",
        dnsClashApiUiPathDesc: "Clash API Web UI 檔案路徑",
        dnsTabShared: "通用設定",
        dnsOverrideHint: "留空就從通用設定自動生成",
        dnsNativeHint: "原生 dns 設定段",
        dnsDnsRules: "DNS 規則",
        dnsDnsRulesOverride: "自定義 DNS 規則",
