export default {
  ...
  sourceDebug: {
    ...
    targetHost: "対象ホスト",
    scheme: "スキーム",
    dnsDuration: "DNS 解決時間",
    resolvedAddresses: "DNS 解決結果",
    dnsError: "DNS エラー",
    resolverConfig: "システム DNS 設定",
    proxyEnvironment: "プロキシ環境変数",
    tcpProbes: "TCP 直接接続テスト",
    address: "アドレス",
    localAddress: "ローカルアドレス",
    remoteAddress: "実際のリモートアドレス",
    httpVersion: "HTTP バージョン",
    tlsCertificate: "TLS ピア証明書",
    requestErrorDetails: "低レベル要求エラーチェーン",
    rawError: "完全なデバッグエラー",
    error: "エラー",
    none: "なし",
    detectedFormat: "検出形式",
