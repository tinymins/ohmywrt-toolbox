  ...
  translation: {
    ...
    proxy: {
      ...
      form: {
        ...
        dnsLocalDnsDesc: "用於解析中國大陸網域嘅本機 DNS 地址",
        dnsLocalDnsPort: "本機 DNS 埠",
        dnsFakeipEnabled: "開啟 FakeIP",
        dnsFakeipEnabledDesc: "開啟 FakeIP 模式以加快 DNS 解析",
        ...
        dnsDnsListenPort: "DNS 監聽埠",
        dnsDnsListenPortDesc: "Sing-box DNS 服務監聽埠",
        dnsTproxyPort: "TProxy 埠",
        dnsTproxyPortDesc: "透明代理埠（Clash / Sing-box）",
        dnsRejectHttps: "攔截 HTTPS DNS",
        dnsRejectHttpsDesc: "攔截系統發出嘅 HTTPS 類型 DNS 查詢",
        dnsCnDomainLocalDns: "國內網域行本機 DNS",
        dnsCnDomainLocalDnsDesc: "中國大陸網域用本機 DNS 解析",
        dnsClashApiPort: "Clash API 埠",
        dnsClashApiPortDesc: "Sing-box Clash API 監聽埠",
        dnsClashApiSecret: "Clash API 密匙",
        dnsClashApiUiPath: "Clash UI 路徑",
        dnsClashApiUiPathDesc: "Clash API Web UI 檔案路徑",
        dnsTabShared: "通用設定",
        dnsOverrideHint: "留空就會從通用設定自動生成",
