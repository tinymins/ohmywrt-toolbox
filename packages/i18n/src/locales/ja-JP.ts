  ...
  translation: {
    ...
    proxy: {
      ...
      debug: {
        ...
        traceNoGroupAssigned: "グループに割り当てられていません（読み取り専用）",
      ...
      form: {
        ...
        subscribeUrlLabel: "サブスクリプションURL (JSON配列、コメント対応)",
        subscribeUrlRequired: "サブスクリプションURLを入力してください",
