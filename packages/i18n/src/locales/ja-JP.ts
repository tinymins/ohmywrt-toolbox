...
export const jaJP = {
  translation: {
    ...
    dashboard: {
      ...
      newSubscriptionDesc: "新しいプロキシサブスクリプションを作成",
      manageSubscriptions: "サブスクリプション管理",
      manageSubscriptionsDesc: "すべてのサブスクリプションを表示・編集",
      unnamedSubscription: "無名サブスクリプション",
      createdBy: "作成者：",
      neverAccessed: "未アクセス",
      menu: {
        workbench: "🏠 ワークベンチ",
    ...
    proxy: {
      title: "プロキシサブスクリプション管理",
      newSubscribe: "新規サブスクリプション",
      editSubscribe: "サブスクリプション編集",
      deleteSuccess: "削除しました",
      deleteFailed: "削除に失敗しました",
      ...
      confirmDelete: "削除の確認",
      confirmDeleteDesc: "このサブスクリプションを削除してもよろしいですか？",
      columns: {
        creator: "作成者",
        remark: "備考",
      ...
      debug: {
        ...
        rawResponse: "生レスポンス",
        format: "形式",
        nodesBeforeFilter: "フィルター前ノード数",
        nodesAfterFilter: "フィルター後ノード数",
        filteredNodes: "除外されたノード",
        finalConfig: "最終設定",
        ...
        error: "エラー",
        serverCount: "サーバー数",
        subscribeUrls: "サブスクリプションURL",
        filterRules: "フィルタールール",
        groupConfig: "グループ設定",
        ruleListConfig: "ルールリスト設定",
        customConfigRules: "カスタムルール",
        dnsConfig: "DNS 設定",
        totalNodes: "合計ノード数",
        activeNodes: "有効ノード",
        filteredCount: "除外",
        ...
        traceSource: "ソース",
        traceParse: "解析",
        traceFilter: "フィルターチェック",
        traceEnrich: "名前エンリッチメント",
        traceMerge: "ノード統合",
        traceGroupAssign: "グループ割り当て",
        traceConvert: "形式変換",
        traceOutput: "最終出力",
        traceSearchPlaceholder: "ノード名を検索...",
        traceSkipped: "スキップ（ノードがフィルターされました）",
        traceFilterPassed: "通過",
        traceFilterBlocked: "除外",
        tracePosition: "位置",
        traceOriginalName: "元の名前",
        traceEnrichedName: "エンリッチ後の名前",
        traceAssignedGroups: "割り当てグループ",
        traceNoGroupAssigned:
          "グループに割り当てられていません（読み取り専用）",
        ...
        traceMatchedRule: "一致ルール",
        traceSingboxOutbound: "Sing-box アウトバウンド",
        traceConfigFragment: "設定フラグメント",
        traceManual: "手動",
        traceNodeNotFound: "ノードが見つかりません",
        traceLoading: "ノードをトレース中...",
        traceSelectNode: "ノードを選択してトレースを表示",
        traceNodeList: "ノードリスト",
        traceFilteredLabel: "除外済み",
      },
      tabs: {
        basic: "基本情報",
        subscribeUrl: "ソース",
      ...
      form: {
        remark: "備考",
        remarkPlaceholder: "サブスクリプション備考",
        authorizedUsers: "許可ユーザー",
        authorizedUsersPlaceholder: "許可するユーザーを選択（任意）",
        authorizedUsersOwnerOnly: "作成者のみが許可ユーザーを変更できます",
        ...
        subscribeItemPrefixTip:
          "このソースの全ノード名の前に付与、例： 『空港A | 』",
        subscribeItemRemark: "備考",
        subscribeItemCacheTtlPlaceholder: "キャッシュ",
        subscribeItemEnabled: "有効",
        subscribeItemDisabled: "無効",
        addSubscribeItem: "ソースを追加",
        ruleListLabel: "ルールリスト (JSONオブジェクト、コメント対応)",
        ruleListPlaceholder:
          '{"グループ名": [{"name": "ルール名", "url": "ルールURL"}]}',
        groupLabel: "グループ設定 (JSON配列、コメント対応)",
        groupPlaceholder:
          '[{"name": "グループ名", "type": "select", "proxies": ["ノード1"]}]',
        filterLabel: "ノードフィルター (JSON配列、コメント対応)",
        filterPlaceholder: '["キーワード1", "キーワード2"]',
        customConfigLabel: "カスタムルール (JSON配列、コメント対応)",
        customConfigPlaceholder: '["DOMAIN,example.com,DIRECT"]',
        serversLabel: "追加サーバー (JSON配列、コメント対応)",
        serversPlaceholder:
          '[{"name": "サーバー名", "type": "ss", "server": "1.2.3.4", "port": 443}]',
        dnsConfigLabel: "DNS設定 (JSONC、コメント対応)",
        dnsConfigPlaceholder: '{"localDns": "127.0.0.1", "fakeipEnabled": true}',
        dnsLocalDns: "ローカルDNSサーバー",
        dnsLocalDnsDesc: "中国大陸のドメインを解決するためのローカルDNSアドレス",
        dnsLocalDnsPort: "ローカルDNSポート",
        dnsFakeipEnabled: "FakeIPを有効にする",
        dnsFakeipEnabledDesc: "FakeIPモードを有効にしてDNS解決を高速化",
        dnsFakeipIpv4Range: "FakeIP IPv4範囲",
        dnsFakeipIpv6Range: "FakeIP IPv6範囲",
        dnsFakeipTtl: "FakeIP TTL",
        dnsFakeipTtlDesc: "FakeIPキャッシュTTL（秒）",
        dnsDnsListenPort: "DNSリスンポート",
        dnsDnsListenPortDesc: "Sing-box DNSサービスリスンポート",
        dnsTproxyPort: "TProxyポート",
        dnsTproxyPortDesc: "透過プロキシポート（Clash / Sing-box）",
        dnsRejectHttps: "HTTPS DNSを拒否",
        dnsRejectHttpsDesc: "システムからのHTTPS型DNSクエリをブロック",
        dnsCnDomainLocalDns: "CNドメインはローカルDNSを使用",
        dnsCnDomainLocalDnsDesc: "中国のドメインをローカルDNSで解決",
        dnsClashApiPort: "Clash APIポート",
        dnsClashApiPortDesc: "Sing-box Clash APIリスンポート",
        dnsClashApiSecret: "Clash APIシークレット",
        dnsClashApiUiPath: "Clash UIパス",
        dnsClashApiUiPathDesc: "Clash API Web UIディレクトリパス",
        dnsTabShared: "共通設定",
        dnsOverrideHint: "空欄にすると共通設定から自動生成されます",
        dnsNativeHint: "ネイティブ dns 設定セクション",
        dnsDnsRules: "DNS ルール",
        dnsDnsRulesOverride: "カスタムDNSルール",
        dnsDnsRulesOverrideDesc: "デフォルトDNSルーティングルールを完全に上書き（上級）",
      ...
      preview: {
        ...
        unnamed: "無名サブスクリプション",
        noNodes: "ノードが見つかりません",
        totalNodes: "合計 {{total}} ノード、有効 {{active}} ノード",
        filtered: "フィルター済み",
        clickToExpand: "行をクリックして詳細を表示",
        expand: "詳細を表示",
        collapse: "折りたたむ",
        source: "ソース",
        manual: "手動",
        ...
        clickToCopyFull: "クリックで完全なシークレットをコピー",
        filteredBy: "ルール「{{rule}}」でフィルターされました",
        noDetailInfo: "詳細設定情報がありません",
        filters: {
          validNodes: "有効なノード",
          filtered: "フィルター済み",
        },
