  ...
  translation: {
    ...
    proxy: {
      ...
      debug: {
        ...
        traceSource: "Source",
        traceParse: "Parse",
        traceFilter: "Filter Check",
        traceEnrich: "Name Enrichment",
        traceMerge: "Node Merge",
        traceGroupAssign: "Group Assignment",
        traceConvert: "Format Conversion",
        traceOutput: "Final Output",
        traceSearchPlaceholder: "Search node name...",
        traceSkipped: "Skipped (node filtered)",
        traceFilterPassed: "Passed",
        traceFilterBlocked: "Filtered",
        tracePosition: "Position",
        traceOriginalName: "Original Name",
        traceEnrichedName: "Enriched Name",
        traceAssignedGroups: "Assigned Groups",
        traceNoGroupAssigned: "Not assigned to any group (readonly only)",
        ...
        traceLoading: "Tracing node...",
        traceSelectNode: "Select a node to view its trace",
        traceNodeList: "Node List",
        traceFilteredLabel: "Filtered",
      },
      tabs: {
        basic: "Basic Info",
        subscribeUrl: "Sources",
        ruleList: "Rule List",
        group: "Groups",
        filter: "Filters",
      ...
      form: {
        ...
        subscribeItemPrefixTip:
          "Prepended to all node names from this source, e.g. 'AirportA | '",
        subscribeItemRemark: "Note",
        subscribeItemCacheTtlPlaceholder: "Cache",
        subscribeItemEnabled: "Enabled",
        subscribeItemDisabled: "Disabled",
        addSubscribeItem: "Add Source",
        ...
        dnsConfigLabel: "DNS Config (JSONC, comments supported)",
        dnsConfigPlaceholder: '{"localDns": "127.0.0.1", "fakeipEnabled": true}',
        dnsLocalDns: "Local DNS Server",
        dnsLocalDnsDesc: "Local DNS address for resolving domestic domains",
        dnsLocalDnsPort: "Local DNS Port",
        dnsFakeipEnabled: "Enable FakeIP",
        dnsFakeipEnabledDesc: "Enable FakeIP mode to speed up DNS resolution",
        dnsFakeipIpv4Range: "FakeIP IPv4 Range",
        dnsFakeipIpv6Range: "FakeIP IPv6 Range",
        dnsFakeipTtl: "FakeIP TTL",
        dnsFakeipTtlDesc: "FakeIP cache TTL (seconds)",
        dnsDnsListenPort: "DNS Listen Port",
        dnsDnsListenPortDesc: "Sing-box DNS service listen port",
        dnsTproxyPort: "TProxy Port",
        dnsTproxyPortDesc: "Transparent proxy port (Clash / Sing-box)",
        dnsRejectHttps: "Reject HTTPS DNS",
        dnsRejectHttpsDesc: "Block HTTPS-type DNS queries from the system",
        dnsCnDomainLocalDns: "CN Domains via Local DNS",
        dnsCnDomainLocalDnsDesc: "Resolve Chinese domains using local DNS",
        dnsClashApiPort: "Clash API Port",
        dnsClashApiPortDesc: "Sing-box Clash API listen port",
        dnsClashApiSecret: "Clash API Secret",
        dnsClashApiUiPath: "Clash UI Path",
        dnsClashApiUiPathDesc: "Clash API Web UI directory path",
        dnsTabShared: "Shared Settings",
        dnsOverrideHint: "Leave empty to auto-generate from shared settings",
        dnsNativeHint: "native dns config section",
        dnsDnsRules: "DNS Rules",
        dnsDnsRulesOverride: "Custom DNS Rules",
        dnsDnsRulesOverrideDesc: "Completely overrides default DNS routing rules (advanced)",
