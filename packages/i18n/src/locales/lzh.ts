  ...
  translation: {
    ...
    proxy: {
      ...
      form: {
        ...
        subscribeItemEnabled: "已啟",
        subscribeItemDisabled: "已停",
        addSubscribeItem: "添訂閱源",
        ...
        dnsLocalDnsDesc: "用於解析中國大陸域名之本機 DNS 地址",
        dnsLocalDnsPort: "本機 DNS 端口",
        dnsFakeipEnabled: "啟用 FakeIP",
        dnsFakeipEnabledDesc: "啟用 FakeIP 以加速 DNS 解析",
        ...
        dnsRejectHttpsDesc: "攔截系統發出之 HTTPS 類型 DNS 查詢",
        dnsCnDomainLocalDns: "國內域名走本機 DNS",
        dnsCnDomainLocalDnsDesc: "中國大陸域名用本機 DNS 解析",
